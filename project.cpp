...
void tabla(int lado){
    ...
    GLfloat positionX = -windowWidth/2;
    GLfloat positionZ = -windowHeight/2;

    int numPiezasAncho = windowWidth/(lado*2);
    int numPiezasAlto = windowHeight/(lado*2);
